...
router.post("/pre-sign", async (req, res) => {
...
router.post("/pre-sign-single", async (req, res) => {
...
router.post("/report-chunk", async (req, res) => {
  const { fileHash, chunkIndex } = req.body;
...
router.post("/merge-report", async (req, res) => {
